...
INSERT INTO `elementos` (`IDELEMENTO`, `IDSEDE`, `NOMBRE`, `TIPO`, `USO`, `FECHACOMPRA`, `IMGELEMENTO`, `SOPORTE`, `CREATED_AT`, `UPDATED_AT`) VALUES
	...
	(7, 3, 'TRX', 'Accesorio', 'Entrenamiento Funcional', '2022-09-14', 'images/elementos/trx.jpg', 'Soporte.pdf', NULL, '2023-12-04 06:04:19'),
...
INSERT INTO `ropa` (`IDROPA`, `NOMBRE`, `TIPO`, `DESCRIPCION`, `STOCK`, `PRECIO`, `TALLA`, `COLOR`, `SEXO`, `MATERIAL`, `IMGPRENDA1`, `IMGPRENDA2`, `IMGPRENDA3`) VALUES
	...
	(11, 'Camiseta de Manga Corta', 'Camisetas', 'Camiseta deportiva de manga cortica :)', 80, 28000.000000, 'M', 'Negro', 'Hombre', 'Algodón', NULL, NULL, NULL),
...
-- Volcando datos para la tabla gimnasio.users: ~11 rows (aproximadamente)
INSERT INTO `users` (`id`, `IDSEDE`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Dios', 'dios@test.com', NULL, '$2y$10$.U0ub4TOXRa7bw9E38WD/.Pi7r0Gcj1hKjWEJncPVjsF2AY1e0Cue', '2C1yxyUqgO0HbyyTn0l1CmTfTCtArjB4FQNvaW6dM1wCW7n7GnClCOcULsAN', '2023-08-12 03:55:28', '2023-08-12 03:55:28'),
