...
<!-- Custom Css -->
<link rel="stylesheet" href="{{ asset('css/ropaMujer.css') }}">
    ...
    @foreach ($prendas as $prenda)
                    <div class="col col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{route('detalleRopaMujer')}}"><button type="button" class="btn btn-dark btn-comprar ms-auto mt-4">Detalles</button></a>
                            </div>
                        </div>
                        </div>
                    </div>
