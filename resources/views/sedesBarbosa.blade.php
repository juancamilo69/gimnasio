<!-- Título web -->
<title>Sedes en Barbosa - Reich gym</title>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4 contenedor-cards-barbosa">
                    <div class="col">
                        <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Reich Gym Sede Barbosa</h5>
                            <p class="card-text">Avenida Nte. #64 - 160.</p>
                        </div>
                        </div>
                    </div>
                    </div>
