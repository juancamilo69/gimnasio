...
<!-- CARD ELEMENTOS -->
<div class="cards-membresias-contenedor row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4" id="cardId">
        ...
        <div class="col col-sm-6 col-md-4">
            <div class="card h-100 w-100 text-white bg-dark">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('elementos.edit', $elemento->IDELEMENTO) }}"><button type="button" class="btns btn btn-light">Editar</button></a>
