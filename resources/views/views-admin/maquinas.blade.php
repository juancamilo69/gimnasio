<!-- Título web -->
<title>Máquinas - Panel de administración - Reich gym</title>
            ...
            <div class="card h-100 w-100 text-white bg-dark">
                ...
                <div class="card-body">
                    ...
                    <div class="btns-card">
                        ...
                        <a href="{{ route('maquinas.edit', $maquina->IDEQUIPO) }}"><button type="button" class="btns btn btn-light btn-editar">Editar</button></a>
                        <a href="{{ route('maquinas.destroy', $maquina->IDEQUIPO) }}" onclick="return confirm('¿Seguro que quiere eliminar este elemento?')"><button type="button" class="btns btn btn-light btn-eliminar">Eliminar</button></a>
                    </div>    
                </div>
            </div>
        </div>
